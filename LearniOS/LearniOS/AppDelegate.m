...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //Google map service
    [GMSServices provideAPIKey:@"AIzaSyAlD2Q9zRCc7iJuT_k5JP5BERXpYg4Gk6I"];
    ...
    DRSLoginVCViewController *viewController = [[DRSLoginVCViewController alloc] initWithNibName:@"DRSLoginVCViewController"
                                                        bundle:nil];
