...
- (void)viewDidLoad {
    ...
    self.NotificationArr=[NSArray arrayWithObjects:@"Local Notification",@"Push Notification", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [self.NotificationArr objectAtIndex:indexPath.row];
