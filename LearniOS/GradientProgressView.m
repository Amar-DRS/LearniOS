...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        UIColor *color;
        color=[UIColor colorWithRed:255.0f/255.0f green:15.0f/255.0f blue:254.0f/255.0f alpha:1.0f];
        [colors addObject:(id)[color CGColor]];
        color=[UIColor colorWithRed:227.0f/255.0f green:152.0f/255.0f blue:91.0f/255.0f alpha:1.0f];
        [colors addObject:(id)[color CGColor]];
        color=[UIColor colorWithRed:67.0f/255.0f green:182.0f/255.0f blue:74.0f/255.0f alpha:1.0f];
        [colors addObject:(id)[color CGColor]];
        color=[UIColor colorWithRed:0.0f/255.0f green:242.0f/255.0f blue:255.0f/255.0f alpha:1.0f];
        [colors addObject:(id)[color CGColor]];
